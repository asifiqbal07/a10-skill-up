                                ...
                                <div className='ms-lg-5 ps-lg-5 mt-3 mt-lg-0'>
                                    <div className='d-lg-flex flex-column align-items-center'>
                                        ...
                                        <Pdf targetRef={ref} filename="code-example.pdf">
                                            {({ toPdf }) => <Button onClick={toPdf} variant="link" className='border-0 p-0 text-danger'><FaDownload>Generate Pdf</FaDownload></Button>
                                        }</Pdf>
                                        {/* <FaDownload className='text-danger fs-5 mt-1'></FaDownload></Link> */}
                                </div>
                            </div>
                        </div>
                        <div className='mt-4 border-start border-5'>
